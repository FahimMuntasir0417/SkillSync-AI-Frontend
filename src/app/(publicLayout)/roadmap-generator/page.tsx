...
export default function PublicRoadmapGeneratorPage() {
  const roadmapMutation = useGenerateRoadmap();

  return (
    <main className="container-shell grid gap-6 py-10">
      <PageHeader
        eyebrow="AI tools"
      ...
      <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <RoadmapForm
          ...
          onSubmit={(payload) => roadmapMutation.mutate(payload)}
        />
        <RoadmapResult
          error={roadmapMutation.error}
          isLoading={roadmapMutation.isPending}
          result={roadmapMutation.data}
        />
      </div>
    </main>
  );
